...
class HtmlElement {
    ...
    public static function a($content = '') { return new A($content); }
    public static function abbr($content = '') { return new Abbr($content); }
    public static function acronym($content = '') { return new Acronym($content); }
    public static function address($content = '') { return new Address($content); }
    public static function applet($content = '') { return new Applet($content); }
    public static function area($content = '') { return new Area($content); }
    public static function article($content = '') { return new Article($content); }
    public static function aside($content = '') { return new Aside($content); }
    public static function audio($content = '') { return new Audio($content); }
    public static function b($content = '') { return new B($content); }
    public static function base($content = '') { return new Base($content); }
    public static function basefont($content = '') { return new Basefont($content); }
    public static function bdi($content = '') { return new Bdi($content); }
    public static function bdo($content = '') { return new Bdo($content); }
    public static function big($content = '') { return new Big($content); }
    public static function blink($content = '') { return new Blink($content); }
    public static function blockquote($content = '') { return new Blockquote($content); }
    public static function body($content = '') { return new Body($content); }
    public static function br($content = '') { return new Br($content); }
    public static function button($content = '') { return new Button($content); }
    public static function canvas($content = '') { return new Canvas($content); }
    public static function caption($content = '') { return new Caption($content); }
    public static function center($content = '') { return new Center($content); }
    public static function cite($content = '') { return new Cite($content); }
    public static function code($content = '') { return new Code($content); }
    public static function col($content = '') { return new Col($content); }
    public static function colgroup($content = '') { return new Colgroup($content); }
    public static function command($content = '') { return new Command($content); }
    public static function content($content = '') { return new Content($content); }
    public static function data($content = '') { return new Data($content); }
    public static function datalist($content = '') { return new Datalist($content); }
    public static function dd($content = '') { return new Dd($content); }
    public static function del($content = '') { return new Del($content); }
    public static function details($content = '') { return new Details($content); }
    public static function dfn($content = '') { return new Dfn($content); }
    public static function dialog($content = '') { return new Dialog($content); }
    public static function dir($content = '') { return new Dir($content); }
    public static function div($content = '') { return new Div($content); }
    public static function dl($content = '') { return new Dl($content); }
    public static function dt($content = '') { return new Dt($content); }
    public static function element($content = '') { return new Element($content); }
    public static function em($content = '') { return new Em($content); }
    public static function embed($content = '') { return new Embed($content); }
    public static function fieldset($content = '') { return new Fieldset($content); }
    public static function figcaption($content = '') { return new Figcaption($content); }
    public static function figure($content = '') { return new Figure($content); }
    public static function font($content = '') { return new Font($content); }
    public static function footer($content = '') { return new Footer($content); }
    public static function form($content = '') { return new Form($content); }
    public static function frame($content = '') { return new Frame($content); }
    public static function frameset($content = '') { return new Frameset($content); }
    public static function h($content = '') { return new H($content); }
    public static function head($content = '') { return new Head($content); }
    public static function header($content = '') { return new Header($content); }
    public static function hr($content = '') { return new HrElement($content); }
    public static function html($content = '') { return new Html($content); }
    public static function i($content = '') { return new I($content); }
    public static function iframe($content = '') { return new Iframe($content); }
    public static function img($content = '') { return new Img($content); }
    public static function image($content = '') { return new Image($content); }
    public static function input($content = '') { return new Input($content); }
    public static function ins($content = '') { return new Ins($content); }
    public static function isindex($content = '') { return new Isindex($content); }
    public static function kbd($content = '') { return new Kbd($content); }
    public static function keygen($content = '') { return new Keygen($content); }
    public static function label($content = '') { return new Label($content); }
    public static function legend($content = '') { return new Legend($content); }
    public static function li($content = '') { return new Li($content); }
    public static function link($content = '') { return new Link($content); }
    public static function listing($content = '') { return new Listing($content); }
    public static function main($content = '') { return new Main($content); }
    public static function map($content = '') { return new Map($content); }
    public static function marquee($content = '') { return new Marquee($content); }
    public static function mark($content = '') { return new Mark($content); }
    public static function menuitem($content = '') { return new Menuitem($content); }
    public static function meta($content = '') { return new Meta($content); }
    public static function meter($content = '') { return new Meter($content); }
    public static function multicol($content = '') { return new Multicol($content); }
    public static function nav($content = '') { return new Nav($content); }
    public static function nextid($content = '') { return new Nextid($content); }
    public static function nobr($content = '') { return new Nobr($content); }
    public static function noembed($content = '') { return new Noembed($content); }
    public static function noscript($content = '') { return new Noscript($content); }
    public static function noframes($content = '') { return new Noframes($content); }
    public static function object($content = '') { return new Object($content); }
    public static function ol($content = '') { return new Ol($content); }
    public static function optgroup($content = '') { return new Optgroup($content); }
    public static function option($content = '') { return new Option($content); }
    public static function output($content = '') { return new Output($content); }
    public static function p($content = '') { return new P($content); }
    public static function param($content = '') { return new Param($content); }
    public static function picture($content = '') { return new HtmlPicture($content); }
    public static function plaintext($content = '') { return new Plaintext($content); }
    public static function pre($content = '') { return new Pre($content); }
    public static function progress($content = '') { return new Progress($content); }
    public static function q($content = '') { return new Q($content); }
    public static function rb($content = '') { return new Rb($content); }
    public static function rp($content = '') { return new Rp($content); }
    public static function rt($content = '') { return new Rt($content); }
    public static function rtc($content = '') { return new Rtc($content); }
    public static function ruby($content = '') { return new Ruby($content); }
    public static function s($content = '') { return new S($content); }
    public static function samp($content = '') { return new Samp($content); }
    public static function script($content = '') { return new Script($content); }
    public static function section($content = '') { return new Section($content); }
    public static function select($content = '') { return new Select($content); }
    public static function slot($content = '') { return new Slot($content); }
    public static function small($content = '') { return new Small($content); }
    public static function source($content = '') { return new Source($content); }
    public static function span($content = '') { return new Span($content); }
    public static function spacer($content = '') { return new Spacer($content); }
    public static function strike($content = '') { return new Strike($content); }
    public static function strong($content = '') { return new Strong($content); }
    public static function style($content = '') { return new Style($content); }
    public static function sub($content = '') { return new Sub($content); }
    public static function summary($content = '') { return new Summary($content); }
    public static function sup($content = '') { return new Sup($content); }
    public static function table($content = '') { return new Table($content); }
    public static function tbody($content = '') { return new Tbody($content); }
    public static function td($content = '') { return new Td($content); }
    public static function template($content = '') { return new Template($content); }
    public static function textarea($content = '') { return new Textarea($content); }
    public static function tfoot($content = '') { return new Tfoot($content); }
    public static function th($content = '') { return new Th($content); }
    public static function thead($content = '') { return new Thead($content); }
    public static function time($content = '') { return new Time($content); }
    public static function title($content = '') { return new Title($content); }
    public static function tr($content = '') { return new Tr($content); }
    public static function track($content = '') { return new Track($content); }
    public static function tt($content = '') { return new Tt($content); }
    public static function u($content = '') { return new U($content); }
    public static function ul($content = '') { return new Ul($content); }
    public static function var($content = '') { return new Var($content); }
    public static function video($content = '') { return new Video($content); }
